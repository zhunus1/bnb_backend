...
admin.site.register(StartUpStage, StartUpStageAdmin)
...
admin.site.register(BussinessModel, BussinessModelAdmin)
...
admin.site.register(SellingModel, SellingModelAdmin)
...
admin.site.register(InnovationMethod, InnovationMethodAdmin)
...
admin.site.register(InvestStage, InvestStageAdmin)